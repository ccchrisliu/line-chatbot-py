...
# Line Bot驗證
line_bot_api = LineBotApi("xrPVP5YS1DXuKaYBK8pqsByfrwoPlNEFJX4lXQdPObGx9NVDRSJ1nUqGQR80ItESdwsKfs3KMZS1ZDUNzowBjTRaLnAmW0L2ELWdTLcSBSdOhtMYLWcThXAIvzTqrzzB4ltwfQgPFXW5ic0jUH40QwdB04t89/1O/w1cDnyilFU=")    #您的Line Bot Channel Access Token
handler = WebhookHandler("41b70fcddd4420413ff2e2ddf106662c") #您的Line Bot Channel Secret
# Push訊息到指定的UserID中
